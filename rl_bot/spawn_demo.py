"""
ROS 2 node to spawn robot.

"""
import os # Operating system library
import sys # Python runtime environment library
import rclpy # ROS Client Library for Python
import xacro # XML macro processor for ROS
...
def main():
    ...
    node.get_logger().info("Spawn robot node started")
    ...
    print(f"[DEBUG] GAZEBO_MODEL_PATH={os.environ.get('GAZEBO_MODEL_PATH')}")
